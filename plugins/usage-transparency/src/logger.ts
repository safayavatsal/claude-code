/**
 * Logger for Usage Transparency Plugin
 */
...
export class Logger {
  ...
  constructor(component: string = 'UsageTransparency', logLevel: LogLevel = LogLevel.INFO) {
  ...
  private sanitizeContext(context: any): any {
    ...
    if (typeof context === 'string' && context.length > 200) {
      return context.substring(0, 200) + '... [truncated]';
    }
    return context;
  }
